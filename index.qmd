...
lobster_icon <- makeIcon(
  iconUrl = "../media/lobster.png", # <1>
  iconWidth = 30, iconHeight = 30
)
```
1. File path to our lobster image, relative to this file (we need to back out a directory level, from `/keys` to `SORTEE-May2023`, then into `media/lobster.png`)
